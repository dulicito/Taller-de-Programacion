...
public class SistemaMes extends Sistema {
    ...
    public SistemaMes(String nombre,double latitud,double longitud,int anioInicial,int cantidadAnios){
    ...
    public String calcularPromedio() {
        ...
        for(y=0;y<MES;y++){
            ...
            aux="La temperatura promedio del mes: "+x+" es de: "+String.format("%.2f",(double)total/12)+"\n";
        }
        return aux;
    }
